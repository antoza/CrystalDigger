...
def main():
    ...
    shader2 = Shader("shaders/animatedAndTextured.vert", "shaders/texture.frag")

    light_dir = (0, 0, -100000)
    viewer.add(*[mesh for file in sys.argv[1:] for mesh in load(file, shader2,
        light_dir=light_dir, k_a=(.4, .4, .4), k_d=(1, 1, 1), k_s=(1, 1, 1), s=16.)])
